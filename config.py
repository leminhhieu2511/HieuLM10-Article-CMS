...
class Config(object):
    ...
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'ArticleCMS_DB'
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'thanhhai'
    SQL_PASSWORD = os.environ.get('SQL_PASSWORD') or 'M@tkhau150113'
    ...
    CLIENT_SECRET = "54h7Q~EcqQVESGOAnstAPJAdDNn2i2R7UTEKl"
    ...
    CLIENT_ID = "7cc9afa6-4034-4469-99a2-949ca7be428a"
